package it.idIta.idempiere.LIT_FiscalPrinting.web;
...
public class AppController {
	...
	public ResponseEntity<List<User>> getAll_v1() {
		System.out.println("CIIIIIIIIIIIIIIIIIIIIIIIIIIIII::::::");
	...
	@RequestMapping(value="testScript", headers = "Accept=application/json", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
